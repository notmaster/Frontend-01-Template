...
class Carousel {
  ...
  render() {
    ...
    let root = <div class='carousel'>{this.children}</div>
    ...
    root.addEventListener('mousedown', (e) => {
      ...
      let nextPosition = (position + 1) % this.children.length
      let prevPosition =
        (position - 1 + this.children.length) % this.children.length
      ...
      let up = (evt) => {
        ...
        position =
          (position - offset + this.children.length) % this.children.length
